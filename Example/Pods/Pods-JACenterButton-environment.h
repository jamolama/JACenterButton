...
// JACenterButton
#define COCOAPODS_POD_AVAILABLE_JACenterButton
#define COCOAPODS_VERSION_MAJOR_JACenterButton 0
#define COCOAPODS_VERSION_MINOR_JACenterButton 1
#define COCOAPODS_VERSION_PATCH_JACenterButton 0
